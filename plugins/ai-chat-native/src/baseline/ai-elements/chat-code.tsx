  ...
  return (
    <div className="not-prose my-2 overflow-hidden rounded-lg border border-border/50 bg-muted/40">
      ...
      <div className="border-t border-border/40 bg-background/40">
        <pre
          className={cn(
            "m-0 overflow-x-auto px-3 py-2 font-mono text-xs leading-relaxed text-foreground",
...
function RunInTerminalButton({ command }: { command: string }) {
  ...
  return (
    <Button
      ...
      variant="ghost"
      onClick={onRun}
      className="h-5 gap-1 px-1.5 text-xs font-medium text-muted-foreground hover:text-foreground"
