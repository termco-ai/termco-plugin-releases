...
/**
 * The catalogue of languages the editor can syntax-highlight, each with the
 * lazy loader for its CodeMirror support. Extracted verbatim from the former
 * single `languageDefinitions.ts` (only the `colorSwatches` import path was
 * repointed for the new folder location).
 */
