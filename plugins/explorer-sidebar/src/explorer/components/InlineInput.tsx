/**
 * Self-focusing single-line text input used by the explorer tree for inline
 * rename and create-file/-folder flows. Encapsulates the focus-stealing
 * workarounds so row components can stay presentational.
 */
