/**
 * Pure transforms over the pane tree: querying leaves, splitting, removing, and
 * focus-neighbor selection. Every function is immutable — it returns a new tree
 * (sharing untouched subtrees) rather than mutating in place.
 */

import { isLeaf, type PaneId, type PaneNode, type SplitDir } from "./types";
